...
void Map::addLandmark(Landmark* pMP)
{
    unique_lock<mutex> lock(_mutexMap);
...
void Map::eraseLandmark(Landmark* pMP)
{
    unique_lock<mutex> lock(_mutexMap);
...
void Map::setReferenceLandmarks(const vector<Landmark*>& vpMPs)
{
    unique_lock<mutex> lock(_mutexMap);
...
vector<Landmark*> Map::getReferenceLandmarks()
{
    unique_lock<mutex> lock(_mutexMap);
