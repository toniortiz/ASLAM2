...
public:
    ...
    void addLandmark(Landmark* pMP, const size_t& idx);
    void eraseLandmarkMatch(const size_t& idx);
    void eraseLandmarkMatch(Landmark* pMP);
    void replaceLandmarkMatch(const size_t& idx, Landmark* pMP);
    std::set<Landmark*> getLandmarks();
    std::vector<Landmark*> getLandmarkMatches();
