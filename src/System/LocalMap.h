...
public:
    ...
    std::vector<LandmarkPtr> _localPoints;
...
protected:
    ...
    g2o::EdgeSE3ProjectXYZOnlyPose* addMonoEdge(const FeaturePtr kp, LandmarkPtr pMP);
    g2o::EdgeStereoSE3ProjectXYZOnlyPose* addStereoEdge(const FeaturePtr kpUn, LandmarkPtr pMP);
