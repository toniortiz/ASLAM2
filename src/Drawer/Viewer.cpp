...
void Viewer::run()
{
    ...
    pangolin::Var<int> menuPoints("menu.Points:", 0);
    ...
    shared_ptr<pangolin::Var<bool>> menuOptimizeMap = nullptr;
    if (_denseMap) {
        ...
        menuOptimizeMap = make_shared<pangolin::Var<bool>>("menu.Optimize Map", false, false);
