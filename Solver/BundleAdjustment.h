...
public:
    ...
    static int OptimizeSE3(KeyFrame* pKF1, KeyFrame* pKF2, std::vector<Landmark*>& vpMatches1,
                           g2o::Sim3& g2oS12, const double th2);

protected:
    static void GBA(const std::vector<KeyFrame*>& vpKFs, const std::vector<Landmark*>& vpMPs,
